    ...
    <div className="lg:col-5">
      <div className="mb-8">
        ...
        <div className="rounded bg-theme-light p-8 dark:bg-darkmode-theme-light relative">
          ...
          <div className={"h-16 w-16 rounded-full bg-body dark:bg-darkmode-body absolute inset-y-0 -right-8 my-auto"}></div>
          <div className={"h-16 w-16 rounded-full bg-body dark:bg-darkmode-body absolute inset-0 -left-8 my-auto"}></div>
