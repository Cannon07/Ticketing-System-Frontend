  ...
  useEffect(() => {
    const fetchEventsByCity = async () => {
      ...
      if (response.status != 404) {
        ...
        if (date.today || date.weekend || date.tomorrow || price.Free || price.below_500 || price.between_500_1000 || price.Above_2000 || categories.Rock || categories.Pop || categories.Jazz || categories.Classical|| categories.Hip_hop || categories.Electronic_Dance || categories.Country || categories.R_B_Soul || categories.Folk || categories.Alternative) {
